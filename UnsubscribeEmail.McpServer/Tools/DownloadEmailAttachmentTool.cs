...
public class DownloadEmailAttachmentTool
{
    ...
    [McpServerTool(Name = "download_email_attachment"), Description(
        ...
        "The raw bytes are bounded and returned as base64Content with the response MIME type and attachment metadata. " +
        "maxBytes defaults to 4,000,000 and is clamped to a maximum of 10,000,000; oversized content is rejected before downloading. " +
