...
public class ListEmailAttachmentsTool
{
    ...
    [McpServerTool(Name = "list_email_attachments"), Description(
        ...
        "Pass the exact message ID returned by get_email_content (emails[].id), " +
        ...
        "attachment IDs, names, MIME types, sizes, inline/content IDs, last-modified timestamps, and " +
